 ...
 * 
 */
public class MainFrame_Without_Color extends JFrame implements ActionListener, ItemListener{
		 ...
		 */
		public MainFrame_Without_Color() {
		 ...
		 * @param value
		 */
		public MainFrame_Without_Color(boolean value) {
